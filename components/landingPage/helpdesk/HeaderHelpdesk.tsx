...
export default function HeaderHelpdesk() {
    const router = useRouter();
    const { data: session, status } = useSession();
    
    return (
        <>
            <div className="bg-[#5423E7] text-[#ffffff99]">
                <header className="py-4 sm:py-5" x-data="{expanded: false}">
                    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div className="flex items-center justify-between">
                            <Link href="/help-center" className="shrink-0 cursor-pointer">
            ...
            <section className="herosearch flex flex-col py-40 bg-[#5423E7]">
                <h2 className="text-2xl text-white text-center lg:text-4xl">Hi there, need some help?</h2>
                <div className="relative mt-2 py-10 mx-auto sm:px-6 w-full items-center text-center">
                    <input type="text" name="" id="" placeholder="Search for articles..." value="" className="w-fit ml-5 mr-5 px-10 md:w-6/12 py-5 placeholder-gray-500 border-gray-300 border rounded-lg focus:ring-indigo-600 focus:border-indigo-600 text-base bg-white " />         
                </div>
            </section>
